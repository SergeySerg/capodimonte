...
<header class="header">
	<div class="wrap">
		<div class="logo"></div>
		<ul class="nav">
			<li class="div_link"><a class="link" href="<?php echo get_site_url(); ?>">Главная</a></li>
			<li class="div_link"><a class="link" href="<?php echo get_site_url();?>/delivery">Оформить доставку</a></li>
			<li class="div_link"><a class="link anchor-link" href="/">Меню</a></li>
			<li class="div_link"><a class="link anchor-link" href="/">Статьи</a></li>
			<li class="div_link"><a class="link" href="<?php echo get_page_link('87'); ?>">Галерея</a></li>
			<li class="div_link"><a class="link anchor-link" href="/">Отзывы</a></li>
			<li class="div_link"><a class="link anchor-link" href="/">Контакты</a></li>
		</ul>
	</div>
